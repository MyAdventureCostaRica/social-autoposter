...
REPLY_SYSTEM = (
    ...
    "marks, no emoji unless the writer used one first. Write the reply in the SAME "
    "language the person wrote in. If that language is Spanish, address them with the "
